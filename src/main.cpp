    ...
    while (running) {
...

        {
            ...
            ImGui::Begin("smartphone data"); 
                ...
                ImGui::Text("data from smartphone received:");
                ImGui::Separator();
...

                {
                    ...
                    ImGui::Text("Altitude:  %.2f m", g_data.alt);
                    ImGui::Text("Accuracy:  %.1f m", g_data.acc);
                    ImGui::Separator();
                    ImGui::Text("Net Type:  %s", g_data.type.c_str());
                    ImGui::Text("RSRP:      %d dBm", g_data.rsrp);
                    ImGui::TextUnformatted(g_data.raw.c_str());
                }
